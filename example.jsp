            ...
            <div class="row" id="sort" class=" divi">
                ...
                <div class="col-md-4 col1">
                    <form action="sort.jsp">
                        ...
                        <input type="radio" name="cat1" value="veg" >
...
ResultSet sr=stmt.executeQuery(sql);
	...
	out.print("<tr  onmouseover=this.style.backgroundColor='#ff7979' ; onmouseout=this.style.backgroundColor='white';><td>" + sr.getString("f_name").toUpperCase()  + "</td><td>" + sr.getString("cat1") + "</td><td>"+ r + sr.getInt("price") +"</td><td>" + sr.getString("description") +"</td><td>" + sr.getString("s_name") +"</td><td><a href=c.jsp?s=" + s1 + ">+</a></td></tr>");
            }
        out.print("</table>");
        }
        catch(Exception e)
